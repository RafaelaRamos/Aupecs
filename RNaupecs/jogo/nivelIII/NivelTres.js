...
class NivelTres extends PureComponent {
  ...
  Itens = ({item, index }) => {
    ...
    return (
      <TouchableOpacity disabled={item.disable} style={[styles.item, (item.disable && item.ativo) ? styles.itemCerto : styles.item]} onPress={() => this.verificar(item.letra, index)}  >
  ...
  verificar = (letra, index) => {
    ...
    let completa = this.state.completa
    if (indexCerto >= 0) {
      ...
      erros++
      erro++
      this.setState({ erros: erros, erro:erro
     ...
     detalhes= detalhes+' '+completa+":"+erro+','
  ...
  render() {
    ...
    return (
      ...
      <Container style={{ flex: 1 }} >
        ...
        <ImageBackground source={require("../../assets/fundo/letra.jpg")} resizeMode={'cover'} style={{ flex: 1 }}>
          <ViewJogo>
            ...
            <View style={styles.background}>
              ...
              <View style={styles.teste}>
                ...
                <ImageBackground source={this.state.img} style={{ resizeMode: 'cover', height: 300, width: 300, justifyContent: "center" }} />
              </View>
